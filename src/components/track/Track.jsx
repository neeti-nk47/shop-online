  ...
  return (
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 md:py-5 py-4 mx-auto">
          <div className="flex flex-wrap -m-4 text-center">
            <TrackChilld
              heading="Premium Quality"
              text="We offer 100% original products."
            ...
            <TrackChilld
              ...
              text="We provide amazing offers & discounts"
...
const TrackChilld = (props) => {
  const { heading, text, path } = props;
  const context = useContext(myContext);
  const { toggleMode, mode } = context;
  return (
    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
      ...
      >
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="text-emerald-600 w-12 h-12 mb-3 inline-block"
        >
