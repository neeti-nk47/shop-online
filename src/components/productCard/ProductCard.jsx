    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-2 md:py-4 lg:px-10 mx-auto">
        <div className="lg:w-1/2 w-full mb-3 lg:mb-6">
          <h1
            className="sm:text-3xl text-2xl font-medium font-serif mb-2 text-gray-900"
        ...
        <div className="flex flex-wrap justify-center">
          {loading ? (
            ...
            displayProducts
              ...
              .filter(
                (product) =>
                  filterType === "" || product.category.includes(filterType)
              )
              .filter(
                (product) =>
                  filterPrice === "" || product.price.includes(filterPrice)
              )
              .map((product, index) => {
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="p-5 border-t-2">
                        ...
                        <p
                          className="leading-relaxed font-roboto mb-3"
                          style={{ color: mode === "dark" ? "white" : "" }}
                        >
                          {price}
                        </p>
